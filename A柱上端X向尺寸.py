...
def calculate(stl_path):
    ...
    if dian_3 is not None:
        ...
        # 可视化赋值
        d4, d5, d6, d7 = dian_4_1, dian_5_1, [0,0,0], [0,0,0]
    else:
        #print("点3未找到，执行套2逻辑")
        # 找点5并计算X向尺寸
        ...
        # 可视化赋值
        #d4, d5, d6, d7 = dian_5_2, dian_6_2 if 'dian_6_2' in locals() else [0,0,0], [0,0,0], [0,0,0]
    ...
    # 仅输出：A柱上端X向尺寸
    #print(f"A柱上端X向尺寸: {A_X:.2f}")
    return A_X

if __name__ == "__main__":
    rear_windshield_angle = calculate(r"E:\一汽风噪\点云文件\XpengG9 Outer Surface.stl")
