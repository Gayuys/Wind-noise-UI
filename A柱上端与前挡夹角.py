...
# 加载 STL 文件并获取点云数据
    ...
    # plt.plot(x_range1, y_range1, 'b--', linewidth=2, label=f'拟合直线1: y = {slope1:.2f}x + {intercept1:.2f}')
    # plt.plot(x_range2, y_range2, 'k--', linewidth=2, label=f'拟合直线2: y = {slope2:.2f}x + {intercept2:.2f}')
